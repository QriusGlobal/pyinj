...
class TestInjectMarker:
    ...
    def test_inject_creation(self):
        ...
        inject_with_provider = Inject(provider)
...
class TestGiven:
    ...
    def test_given_delegates_to_inject(self):
        ...
        # Should create similar types
        assert given_db._inject_type == inject_db._inject_type
...
class TestAnalyzeDependencies:
    ...
    def test_analyze_token_annotation(self):
        ...
        def handler(db: token):  # type: ignore
            return db
    ...
    def test_analyze_skip_args_kwargs(self):
        ...
        def handler(db: Inject[Database], *args, **kwargs):
            return db
...
class TestResolveDependencies:
    ...
    def test_resolve_inject_with_type(self):
        ...
        call_args = container.get.call_args[0][0]
        assert isinstance(call_args, Token)
        assert call_args.type_ == Database
    ...
    async def test_resolve_async_provider(self):
        ...
        inject_marker = Inject(async_provider)
        deps = {"db": inject_marker}
...
class TestInjectDecorator:
    ...
    def test_inject_with_override(self):
        ...
        # Override
        result2 = handler(db=override_db)
