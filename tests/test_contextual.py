...
class TestContextualContainer:
    ...
    async def test_async_cleanup(self):
        ...
        mock_resource.aclose = Mock(return_value=asyncio.coroutine(lambda: None)())
...
class TestContextFunctions:
    ...
    def test_get_set_context(self):
        """Test get and set context functions."""
        ...
        # Set context
        chain = ChainMap({"key": "value"})
        token = set_context(chain)
        
        # Should get read-only view
